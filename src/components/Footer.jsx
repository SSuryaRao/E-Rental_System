...
function Footer({ className }) {
  return (
    <footer className={`${className} bg-gray-50 py-12 border-t border-gray-200`}>
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            <h4 className="text-lg font-semibold text-blue-600 mb-5">About</h4> {/* Blue heading */}
            <p className="text-gray-700 text-sm"> {/* Darker text */}
              Simple description about our company and values.
            </p>
          </div>
          <div>
            <h4 className="text-lg font-semibold text-blue-600 mb-5">Links</h4> {/* Blue heading */}
            <ul className="text-gray-700 text-sm"> {/* Darker text */}
              <li className="mb-3"><Link to="/" className="hover:text-blue-500 transition-colors duration-200">Home</Link></li>
              <li className="mb-3"><Link to="/login" className="hover:text-blue-500 transition-colors duration-200">Login</Link></li>
              <li><Link to="/about" className="hover:text-blue-500 transition-colors duration-200">About</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="text-lg font-semibold text-blue-600 mb-5">Contact</h4> {/* Blue heading */}
            <address className="text-gray-700 text-sm not-italic leading-relaxed"> {/* Darker text */}
              <p className="mb-3">Cityville, State</p>
              <p className="mb-3">Email: <a href="mailto:contact@example.com" className="hover:text-blue-500 transition-colors duration-200">Email Us</a></p> {/* Simplified Email link text */}
              <p>Call: (123) 456-7890</p> {/* Simplified Phone text */}
            </address>
          </div>
          <div>
            <h4 className="text-lg font-semibold text-blue-600 mb-5">Follow</h4> {/* Blue heading */}
            <p className="text-gray-700 text-sm mb-4">Social Media:</p> {/* Darker text */}
            <div className="flex items-center gap-5">
              {/* Social Buttons - Keeping your provided structure and SVGs */}
        ...
        <div className="mt-10 py-4 border-t border-gray-200 text-center text-gray-700 text-sm"> {/* Darker copyright text */}
          <p>&copy; {new Date().getFullYear()} <strong className="font-semibold text-blue-600">Your Company</strong>. All rights reserved.</p> {/* Blue Company Name */}
        </div>
      </div>
    </footer>
  );
